...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col md:flex-row items-center gap-12 py-16">
        ...
        >
          ...
          <p
            className="font-inter text-base md:text-lg mb-10 max-w-lg leading-relaxed"
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <Link to="/all-cakes">
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: '0 0 30px rgba(229,91,117,0.3)' }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full font-inter font-bold tracking-widest uppercase text-sm"
            ...
            <Link to="/customize">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full font-inter font-bold tracking-widest uppercase text-sm border-2 transition-colors"
          ...
          <div className="flex gap-8 pt-8 border-t"
            ...
            {[
              ...
              <div key={stat.label}>
                <div className="text-2xl font-playfair font-bold" style={{ color: '#e55b75' }}>
                  {stat.value}
                </div>
                <div className="text-xs font-inter" style={{ color: 'rgba(255,255,255,0.4)' }}>
                  {stat.label}
                </div>
              </div>
            ))}
